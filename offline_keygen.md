...
- email address: **flastname@domain_com**
- Comment: **enter**
...
Note in the output of **gpg --list-secret-keys** the keywords **ssb** which means the subkeys secrets are available on the local GPG keyring.
...
Note in the output of **gpg --list-secret-keys** the keywords **ssb>** which means the subkeys secrets are moved to the Yubikey and only the stubs are available on the local GPG keyring.
